...
uses
  Aaaaaaa, AaaAaaaa, Aaaaa, Aaaaaaa, Aaaaaaaa, Aaaaaaa, AaaAaaaa, Aaaa, Aaaa?;
...
begin      
  ...
  if AaAaaaAaaA_aaaAa.Aaaaaaa then Aaaa?.a[a].A:=AaaaAaaA_aaAaa.Aaaaa;
  if AaAaaaAaaA_aaaAa.Aaaaaaa then Aaaa?.a[a].A:=AaaaAaaA_aaAaa.Aaaaa;
  if AaAaaaAaaaaA_aaaAa.Aaaaaaa then Aaaa?.a[a].AaaaaA:=AaaaAaaaaA_aaAaa.Aaaaa;
  if AaAaaaAaaaaA_aaaAa.Aaaaaaa then Aaaa?.a[a].AaaaaA:=AaaaAaaaaA_aaAaa.Aaaaa;
  if AaAaaaAaaaa_aaaAa.Aaaaaaa then Aaaa?.a[a].Aaaaa:=AaaaAaaaa_aaa.Aaaaa;
  if AaAaaaAaaa_aaaAa.Aaaaaaa then Aaaa?.a[a].Aaaa:=AaaaAaaa_aaAaa.Aaaaa;
end;
